...
# --- Kluczowe wersje (nie zmieniać) ---
SPARK_VERSION="3.5.1"
KAFKA_PYTHON_VERSION="2.2.15"
...
# --- Zależności dopasowane do Spark 3.5.1 ---
HADOOP_VERSION="3.3.6"                         # Kompatybilna z Spark 3.5.x
DELTA_SPARK_VERSION="3.2.0"                    # Oficjalnie wspiera Spark 3.5.x
DELTALAKE_VERSION="0.10.0"                      # Wersja rdzenia Delta
DELTA_PACKAGE_VERSION="io.delta:delta-core_${SCALA_VERSION}:${DELTALAKE_VERSION}"

# --- Dodatkowe pakiety Spark ---
SPARK_XML_PACKAGE_VERSION="com.databricks:spark-xml_${SCALA_VERSION}:0.17.0"
SPARKSQL_MAGIC_VERSION="0.0.3"                 # Stabilna z JupyterLab 4.x

# --- Środowisko Jupyter / Python ---
JUPYTERLAB_VERSION="4.2.5"                     # Zaktualizowana wersja JupyterLab
PANDAS_VERSION="2.0.3"                         # Kompatybilna z PySpark 3.5.x
